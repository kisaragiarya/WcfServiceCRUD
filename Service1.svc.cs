...
namespace WcfService1
{
    ...
    public class Service1 : IService1
    {
        ...
        {
            string msg;
            SqlConnection con = new SqlConnection("Data Source=DESKTOP-EJH2D6F\\ARYA;Initial Catalog=CrudDb;Persist Security Info=True;User ID=sa;Password=arya@cool123");
            con.Open();
